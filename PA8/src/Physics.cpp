...
PhysicsEngine::PhysicsEngine() {
	...
	m_dynamicsWorld->setGravity(btVector3(-0.2, -9.81, -.2));
	createObjects();
}
...
=======
	...
	shapeMotionState = new btDefaultMotionState(btTransform(btQuaternion(0,0,0,1),btVector3(6.3,-1,0)));
	mass = 0;
	...
	shapeMotionState = new btDefaultMotionState(btTransform(btQuaternion(0,0,0,1),btVector3(0,-1,-3.8)));
	mass = 0;
	...
	shapeMotionState = new btDefaultMotionState(btTransform(btQuaternion(0,0,0,1),btVector3(0,-1,4.0)));
	mass = 0;
	...
	shapeMotionState = new btDefaultMotionState(btTransform(btQuaternion(0,0,0,1),btVector3(-7.35,-1,0)));//-5.4
	mass = 0;
	...
	shapeMotionState = new btDefaultMotionState(btTransform(btQuaternion(0,0,0,1),btVector3(28,-1,-2.7)));
	mass = 0;
	...
	m_cylinder1->m_shape = new btCylinderShape(btVector3(1,1,1));
	shapeMotionState = new btDefaultMotionState(btTransform(btQuaternion(0, 0, 0, 1),
	                                                        btVector3(2, 1, 0)));
	mass = 0;
	...
	m_cylinder2->m_shape = new btCylinderShape(btVector3(1,1,1));
	shapeMotionState = new btDefaultMotionState(btTransform(btQuaternion(0, 0, 0, 1),
	                                                        btVector3(1, 20,-50)));
	mass = 0;
	...
	m_cylinder3->m_shape = new btCylinderShape(btVector3(1,1,1));
	shapeMotionState = new btDefaultMotionState(btTransform(btQuaternion(0, 0, 0, 1),
	                                                        btVector3(1, 20,50)));
	mass = 0;
